    ...
    $.fn.eventCal = function(params)
    {
        var defaultCalendarOptions = {
            ...
            eventClick: function(event)
            {
                ...
                $("input[name=EventCal_allDay]").prop('checked', event.allDay);
                $("input[name=EventCal_editable]").prop('checked', event.editable);
            ...
            dayClick: function(date, allDay)
            {
                ...
                $("#EventCal_id").val(0);
                $("#EventCal_title").val('');
                $("input[name=EventCal_allDay]").prop('checked', allDay);
                $("input[name=EventCal_editable]").prop('checked', true);
                var dateEnd = new Date(date);
                dateEnd.setMinutes(dateEnd.getMinutes()+params.calendar.slotMinutes*2);
        ...
        eventDialogOK = function()
        {
            var data =
            {
                ...
                allDay: $('input[name=EventCal_allDay]').prop('checked'),
                editable: $('input[name=EventCal_editable]').prop('checked')
            }
